    ...
    <section className="tuition-plan">
      <div className="tuition-plan__header-container">
        <div className="tuition-plan__title">
          <h1>Tuition payment plans and financing options to fit your needs</h1>
        </div>
        <div className="tuition-plan__subtitle">
          <h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</h3>
        </div>
      </div>
